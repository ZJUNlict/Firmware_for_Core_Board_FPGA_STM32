...
#define MAX_ACC max_acc()//限定车子的加速度

#define WHEEL_CENTER_OFFSET 0.082  /* 轮子距车中心距离(m) */
#define D_WHEEL_ANGLE_FRONT 58//58//55（老车）//60/* 前轮与轴线角度(度) */
#define D_WHEEL_ANGLE_BACK 135//135//128（老车）//125 //134 /* 后轮与轴线角度(度) */
...
#define SHOOTER_INTERVAL 1000// 两次射门间隔时间
