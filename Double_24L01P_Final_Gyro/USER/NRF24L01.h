...
/* 发送模式的24L01配置和选项定义 */
#define RF24L01_CE_GPIO_PORT_2			GPIOE
//#define RF24L01_CE_GPIO_CLK_2				RCC_APB2Periph_GPIOG
#define RF24L01_CE_GPIO_PIN_2				GPIO_Pin_8

#define RF24L01_IRQ_GPIO_PORT_2			GPIOF
//#define RF24L01_IRQ_GPIO_CLK_2			RCC_APB2Periph_GPIOG
#define RF24L01_IRQ_GPIO_PIN_2			GPIO_Pin_14

#define RF24L01_CS_GPIO_PORT_2			SPI_NSS_GPIO_PORT_2			//PG7
#define RF24L01_CS_GPIO_CLK_2				SPI_NSS_GPIO_CLK_2
#define RF24L01_CS_GPIO_PIN_2				SPI_NSS_GPIO_PIN_2


/** 口线操作函数定义 */
#define RF24L01_SET_CE_HIGH_2( )			RF24L01_CE_GPIO_PORT_2->ODR |= RF24L01_CE_GPIO_PIN_2
#define RF24L01_SET_CE_LOW_2( )			RF24L01_CE_GPIO_PORT_2->ODR &= (uint32_t)( ~(uint32_t)RF24L01_CE_GPIO_PIN_2 )

#define RF24L01_SET_CS_HIGH_2( )			spi_set_nss_high_2( )
#define RF24L01_SET_CS_LOW_2( )			spi_set_nss_low_2( )

#define RF24L01_GET_IRQ_STATUS_2( )		(( RF24L01_IRQ_GPIO_PORT_2->IDR & (uint32_t)RF24L01_IRQ_GPIO_PIN_2) != RF24L01_IRQ_GPIO_PIN_2 ) ? 0 : 1	//IRQ状态

#define SPI_CLK_GPIO_PORT_2			GPIOG
//#define SPI_CLK_GPIO_CLK			RCC_APB2Periph_GPIOB
#define SPI_CLK_GPIO_PIN_2			GPIO_Pin_1

#define SPI_MISO_GPIO_PORT_2			GPIOF
//#define SPI_MISO_GPIO_CLK			RCC_APB2Periph_GPIOB
#define SPI_MISO_GPIO_PIN_2			GPIO_Pin_15

#define SPI_MOSI_GPIO_PORT_2			GPIOG
//#define SPI_MOSI_GPIO_CLK			RCC_APB2Periph_GPIOB
#define SPI_MOSI_GPIO_PIN_2			GPIO_Pin_0

#define SPI_NSS_GPIO_PORT_2			GPIOE
//#define SPI_NSS_GPIO_CLK_2			RCC_APB2Periph_GPIOG
#define SPI_NSS_GPIO_PIN_2			GPIO_Pin_7


#define spi_set_nss_high_2( )			SPI_NSS_GPIO_PORT_2->ODR |= SPI_NSS_GPIO_PIN_2								//片选置高
#define spi_set_nss_low_2( )			SPI_NSS_GPIO_PORT_2->ODR &= (uint32_t)( ~((uint32_t)SPI_NSS_GPIO_PIN_2 ))	//片选置低


#define spi_set_clk_high_2( )			SPI_CLK_GPIO_PORT_2->ODR |= SPI_CLK_GPIO_PIN_2								//时钟置高
#define spi_set_clk_low_2( )			SPI_CLK_GPIO_PORT_2->ODR &= (uint32_t)( ~((uint32_t)SPI_CLK_GPIO_PIN_2 ))	//时钟置低

#define spi_set_mosi_hight_2( )		SPI_MOSI_GPIO_PORT_2->ODR |= SPI_MOSI_GPIO_PIN_2							//发送脚置高
#define spi_set_mosi_low_2( )			SPI_MOSI_GPIO_PORT_2->ODR &= (uint32_t)( ~((uint32_t)SPI_MOSI_GPIO_PIN_2 ))	//发送脚置低

#define spi_get_miso_2( )				(( SPI_MISO_GPIO_PORT_2->IDR & (uint32_t)SPI_MISO_GPIO_PIN_2) != SPI_MISO_GPIO_PIN_2 ) ? 0 : 1 // 若相应输入位为低则得到0，相应输入位为高则得到1


void drv_spi_init_2( void );
